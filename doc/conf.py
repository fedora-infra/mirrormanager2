...
mm2file = os.path.join(os.path.dirname(__file__), "..", "mirrormanager2", "__init__.py")

# Thanks to SQLAlchemy:
# https://github.com/zzzeek/sqlalchemy/blob/master/setup.py#L104
with open(mm2file) as stream:
    VERSION = re.compile(r'.*__version__ = "(.*?)"', re.S).match(stream.read()).group(1)
...
htmlhelp_basename = "mirrormanager2"
