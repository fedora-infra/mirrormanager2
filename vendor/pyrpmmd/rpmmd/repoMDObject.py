...
from rpmmd.misc import _available_compression, stat_f
from rpmmd.misc import AutoFileChecksums, to_xml
from rpmmd.Errors import RepoMDError
...
class RepoMD:
    ...
    def parse(self, srcfile):
        if isinstance(srcfile, six.string_types):
        ...
        parser = cElementTree.iterparse(infile)
...
def main():
    ...
    try:
        ...
        print("pyrpmmd: No such file:\'%s\'" % sys.argv[1], file=sys.stderr)
        sys.exit(1)
