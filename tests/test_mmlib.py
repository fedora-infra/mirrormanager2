...
def test_query_directories(db, base_items, site, hosts, directory, category, hostcategory, hostcategoryurl, categorydirectory):
...
def test_get_host_category_by_hostid_category(db, base_items, site, hosts, directory, category, hostcategory):
...
def test_get_host_category_url_by_id(db, base_items, site, hosts, directory, category, hostcategory, hostcategoryurl):
...
def test_get_host_category_url(db, base_items, site, hosts, directory, category, hostcategory, hostcategoryurl):
...
def test_get_mirrors(db, base_items, site, hosts, directory, category, hostcategory, hostcategoryurl, categorydirectory, netblockcountry, repository):
...
def test_get_mirrors_version_empty(db, base_items, site, hosts, directory, category, hostcategory, hostcategoryurl, categorydirectory, netblockcountry):
    results = mirrormanager2.lib.get_mirrors(db, version_id=1)
    assert len(results) == 0
    results = mirrormanager2.lib.get_mirrors(db, version_id=4)


def test_get_mirrors_version(db, base_items, site, hosts, directory, category, hostcategory, hostcategoryurl, categorydirectory, netblockcountry, version, repository):
    results = mirrormanager2.lib.get_mirrors(db, version_id=1)
    assert len(results) == 2
    assert results[0].name == 'mirror2.localhost'
...
def test_get_hostcategorydir_by_hostcategoryid_and_path(db, base_items, site, hosts, directory, category, hostcategory, hostcategorydir):
...
def test_get_directory_exclusive_host(db, base_items, site, hosts, directory, directoryexclusivehost):
