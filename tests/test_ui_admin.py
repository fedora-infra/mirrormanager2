...
def test_admin_category(client, admin_user):
    ...
    assert re.search(
        ...
        'title="Sort by Name">Name</a>', data) is not None
...
def test_admin_country(client, admin_user):
    ...
    assert re.search('<a href="/admin/category(view)?/">Category</a>', data) is not None
    assert re.search(
        r'<a href="/admin/country(view)?/\?sort=0" title="Sort by Code">Code</a>', data
    ) is not None
...
def test_admin_directoryview(client, admin_user):
    ...
    assert re.search('<a href="/admin/category(view)?/">Category</a>', data) is not None
    assert re.search(
        r'<a href="/admin/directory(view)?/\?sort=0" title="Sort by Name">Name</a>', data
    ) is not None
...
def test_admin_directoryexclusivehostview(client, admin_user):
    ...
    output = handle_flask_admin_urls(
        client, '/admin/directoryexclusivehost/')
    assert output.status_code == 200
    data = output.get_data(as_text=True)
...
def test_admin_filegroupview(client, admin_user):
    ...
    assert re.search('<a href="/admin/category(view)?/">Category</a>', data) is not None
    assert re.search(
        r'<a href="/admin/filegroup(view)?/\?sort=0" title="Sort by Name">Name</a>', data
    ) is not None
    assert '<a href="javascript:void(0)">List</a>' in data
...
def test_admin_hostview(client, admin_user):
    ...
    assert re.search('<a href="/admin/category(view)?/">Category</a>', data) is not None
    assert re.search(
        r'<a href="/admin/host(view)?/\?sort=[0-9]" title="Sort by Name">Name</a>', data
    ) is not None
    assert '<a href="javascript:void(0)">List (4)</a>' in data
...
def test_admin_hostaclipview(client, admin_user):
    ...
    assert re.search(
        ...
        'title="Sort by Ip">Ip</a>', data) is not None
    assert '<a href="javascript:void(0)">List</a>' in data
...
def test_admin_hostcategoryurlview(client, admin_user):
    ...
    assert re.search('<a href="/admin/category(view)?/">Category</a>', data) is not None
    assert re.search(
        r'<a href="/admin/hostcategoryurl(view)?/\?sort=[01]" title="Sort by Url">Url</a>', data
    ) is not None
...
def test_admin_hostnetblockview(client, admin_user):
    ...
    assert re.search('<a href="/admin/category(view)?/">Category</a>', data) is not None
    assert re.search(
        r'<a href="/admin/hostnetblock(view)?/\?sort=[012]" title="Sort by Name">Name</a>', data
    ) is not None
...
def test_admin_hostpeerasnview(client, admin_user):
    ...
    assert re.search('<a href="/admin/category(view)?/">Category</a>', data) is not None
    assert re.search(
        r'<a href="/admin/hostpeerasn(view)?/\?sort=[012]" title="Sort by Name">Name</a>', data
    ) is not None
    assert '<a href="javascript:void(0)">List (1)</a>' in data
...
def test_admin_hoststatsview(client, admin_user):
    ...
    assert re.search('<a href="/admin/category(view)?/">Category</a>', data) is not None
    assert re.search(
        r'<a href="/admin/hoststats(view)?/\?sort=[02]" title="Sort by Type">Type</a>', data
    ) is not None
    assert '<a href="javascript:void(0)">List</a>' in data
...
def test_admin_locationview(client, admin_user):
    ...
    assert re.search('<a href="/admin/category(view)?/">Category</a>', data) is not None
    assert re.search(
        r'<a href="/admin/location(view)?/\?sort=0" title="Sort by Name">Name</a>', data
    ) is not None
    assert '<a href="javascript:void(0)">List (3)</a>' in data
...
def test_admin_productview(client, admin_user):
    ...
    assert re.search('<a href="/admin/category(view)?/">Category</a>', data) is not None
    assert re.search(
        r'<a href="/admin/product(view)?/\?sort=0" title="Sort by Name">Name</a>', data
    ) is not None
    assert '<a href="javascript:void(0)">List (2)</a>' in data
...
def test_admin_repositoryview(client, admin_user):
    ...
    assert re.search('<a href="/admin/category(view)?/">Category</a>', data) is not None
    assert re.search(
        r'<a href="/admin/repository(view)?/\?sort=[0-4]" title="Sort by Name">Name</a>', data
    ) is not None
    assert '<a href="javascript:void(0)">List (4)</a>' in data
